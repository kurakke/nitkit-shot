...
export const Ranking = (): JSX.Element => {
  ...
  return (
    <div className='mx-auto mb-[75px] mt-[10px] flex h-[1104px] w-[394px] flex-col'>
      ...
      >
        ...
        <div
          className={classNames(
            `shadow-ranking mx-auto mt-[10px] flex h-[3.82%] w-[80.9%] items-center justify-between rounded-[19px] border-[5px] border-main pl-[10px] pr-[5px]`,
